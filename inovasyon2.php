        ...
        <div class="navbar-container container-fluid">
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
                    ...
                    <li>
                        <h5 class="page-title hidden-menubar-top hidden-float">İnovasyon Fikirleri</h5>
                    </li>
                </ul>
                            ...
                            <div class="widget-body">
                                <div id="addTestCaseForm" style="padding:10px">
                                    ...
                                    <form method="POST" action="add_testcase.php" enctype="multipart/form-data">
                                        ...
                                        <button class="btn mw-md btn-success" style="margin: 3px; width: -webkit-fill-available;" type="submit">Test
                                            Case Ekle</button>
                                    </form>
                                </div>
                            </div>
